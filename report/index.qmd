...
p_annual <- consult_annual %>%
  mutate(
    ...
    bar_color = if_else(year == 2024, "#aab8c2", "#2c7bb6")
  ) %>%
  plot_ly(
  ...
  layout(
    title = list(text = "GIS consultations ran 72–82/year — data ends June 2024, two months before position was vacated", font = list(size = 14)),
